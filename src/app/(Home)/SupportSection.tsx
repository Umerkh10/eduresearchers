            ...
            <div data-aos='fade-down' data-aos-duration="1500" style={{ backgroundImage: "url('/imgs/support_bg.webp')", backgroundSize: 'cover' }} className='py-10'>
                <div className='mx-auto max-w-screen-xl'>
                    <div className='px-3 pt-10'>
                        <h1 className='text-center text-2xl md:text-7xl  font-extrabold text-white text-opacity-10 '>Support</h1>
                        ...
                        <h2 className='pt-4 font-semibold text-center text-zinc-100 text-xl md:text-3xl'>Why Your Should Hire {process.env.NEXT_PUBLIC_NAME}</h2>
