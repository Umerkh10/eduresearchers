    ...
    <div className='mx-auto max-w-screen-xl'>
        ...
        <h1 className='text-center text-4xl md:text-7xl text-muted font-extrabold '>HOW IT WORKS</h1>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 p-5 '>
                <div className=''>
                    <div className='lg:h-[350px] rounded-xl shadow-xl bg-gradient-to-t from-orange-200 to-emerald-50 dark:bg-gradient-to-t dark:from-orange-900 dark:to-zinc-900 p-5'>
