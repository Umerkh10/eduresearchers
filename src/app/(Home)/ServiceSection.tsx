  ...
  return (
    <div className='mx-auto max-w-screen-xl'>
        <div className='mt-10'>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 p-5'>
                <div className=''>
                    <div className=' lg:h-[350px] flex flex-col justify-center p-5 bg-gradient-to-b from-emerald-100 to-orange-200 dark:bg-gradient-to-t dark:from-orange-500 dark:to-zinc-900 rounded-xl'>
