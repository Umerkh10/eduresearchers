        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-3 py-10 '>
            <div className='py-5 lg:pl-24 px-5 '>
                <div className='flex flex-col md:flex-row '>
                    <span className='font-medium pl-2'>Confidential</span>
                    <div className='hidden md:block h-[24px] w-[2px] bg-muted-foreground ml-4 '></div>
                    <span className='font-medium pl-2'>Fast</span>
                    <div className='hidden md:block h-[24px] w-[2px] bg-muted-foreground ml-4 '></div>
                    <span className='font-medium pl-2'>Simple Order Form</span>
                    <div className='hidden md:block h-[24px] w-[2px] bg-muted-foreground ml-4 '></div>
                    <span className='font-medium pl-2'>No Time Wasting</span>
                    </div>
                    ...
                    <p className='text-muted-foreground py-2 font-medium text-center md:text-start '>Here we are providing best assignment assistance to help
