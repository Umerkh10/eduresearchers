...
const FaqSection: React.FC = () => {
  ...
  const renderAccordionTrigger = (value: string, text: string) => (
    <AccordionTrigger
      className='mt-3 scale-95 md:scale-100 bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] lg:w-[500px] xl:w-[600px] md:w-[600px]'
