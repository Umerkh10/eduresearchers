...
function FaqSection() {
  return (
    <div data-aos='fade-down' data-aos-duration="1500" className='mx-auto max-w-screen-xl py-10'>
        <div className='grid lg:grid-cols-2 grid-cols-1'>
            ...
            <div data-aos='flip-up' className=''>
                ...
                <AccordionItem value="item-1">
                    <AccordionTrigger className='bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px]' >Why Should I Hire Your Writer ?</AccordionTrigger>
                    ...
                    <AccordionTrigger className='mt-3 bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px]' >What are your packages for editing services ?</AccordionTrigger>
                    <AccordionContent className='text-muted-foreground font-semibold pt-3 px-4 w-[350px] md:w-[500px]'>
                    ...
                    <AccordionTrigger className='mt-3 bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px]' >Can i collabrate with my assignment writer ?</AccordionTrigger>
                    <AccordionContent className='text-muted-foreground font-semibold pt-3 px-4 w-[350px] md:w-[500px]'>
            ...
            <div className='flex items-center justify-center lg:ml-0 md:ml-20  pt-10'>
                <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                    <AccordionTrigger className='bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px]' >
                    ...
                    <AccordionTrigger className='mt-3 bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px]' >Do you offer guaranteed top results ?</AccordionTrigger>
                    <AccordionContent className='text-muted-foreground font-semibold pt-3 px-4 w-[350px] md:w-[500px]'>
                 We are committed to providing you highest quality assignment work. We provide guaranteed to give you perfectly according to the guidelines to achieve good grades in your degree program. You will assign the relevant writer to work on your assignment. No matter the subject, we have skilled writers from various disciplines.
                    ...
                    <AccordionTrigger className='mt-3 bg-gradient-to-l from-emerald-50 to-orange-200 dark:bg-gradient-to-r dark:from-orange-700 dark:to-zinc-600 font-semibold rounded-lg px-4 w-[350px] md:w-[600px] ' >I don’t find my field on your website.Are your still able to do it ?</AccordionTrigger>
                    <AccordionContent className='text-muted-foreground font-semibold pt-3 px-4 w-[350px] md:w-[500px]'>
