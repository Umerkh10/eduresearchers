        ...
        <Card>
          ...
          <CardContent className="space-y-2 ">
            ...
            <div className='space-y-2 '>
              <button type="submit" disabled={pending} className='flex mt-5 px-8 py-3 bg-orange-500 text-zinc-50 rounded-lg hover:scale-105 transition ease-in duration-200 delay-200 font-medium'>
                {pending ? (
                  <>
                    <Loader2 className="animate-spin mr-2 h-5 w-5" /> <p>Submitting...</p>
                  </>
                ) : (
                  "Order Now"
                )}
